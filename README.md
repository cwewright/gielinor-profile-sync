...
```text
build\distributions\gielinor-profile-sync-preview-bootstrap-0.3.7.zip
```
...
```text
powershell.exe -NoProfile -ExecutionPolicy Bypass -File .\scripts\Verify-PreviewBootstrap.ps1 -Path .\build\distributions\gielinor-profile-sync-preview-bootstrap-0.3.7.zip
```
